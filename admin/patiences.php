    ...
    <main>
     ...
     ?>      
         ...
         <tr>
             ...
             <td> <a href="../modifyC?id=<?=  $row['patient_id'] ?>"><span class="badge text-bg-primary">Edit</span></a></td>
             <td> <a href="../php/controllers/deleteC?id=<?=  $row['patient_email'] ?>"><span class="badge text-bg-danger">Delete</span></a></td>
