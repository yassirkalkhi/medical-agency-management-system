...
try {
    ...
    $sql = "SELECT doctor_name FROM doctors WHERE doctor_id = ?";
...
try {
    ...
    $checked_appointments_count = intval($result['appointments']);
    $additional_fee = $checked_appointments_count * 120;
    echo "$additional_fee";
...
?>$</span><br><span class="fw-semibold fs-5">Transactions</span></div>
                  </div>
